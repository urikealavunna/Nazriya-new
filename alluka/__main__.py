...
def send_start(bot, update):
    ...
    try:
        ...
        pass
    chat = update.effective_chat  # type: Optional[Chat]
    text = "Heya there, my name is Sisira! "
    ...
    keyboard += [[InlineKeyboardButton(text="🔌 Add me",url="http://t.me/Sisira_Bot?startgroup=true"),InlineKeyboardButton(text="👤 Contact creator",url="https://t.me/Vijay_Sai_Devarakonda")]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                InlineKeyboardButton(text="👥 Support chat.",url="https://t.me/Sisira_BotChat")]]))
        return
